  ...
  function showToolTip(rel, view) {
   ...
   if (view === 'top') {
    ...
    // if (view === 'top') {
    //     imageUrl = "https://irt-cdn.multiscreensite.com/5559342e66bc4bf29cf4c79923853db2/dms3rep/multi/" + rel + '-top.png';
    // } else if (view === 'front') {
    //     imageUrl = "https://irt-cdn.multiscreensite.com/5559342e66bc4bf29cf4c79923853db2/dms3rep/multi/" + rel + '-front.png';
    // } else {
    //     imageUrl = "https://irt-cdn.multiscreensite.com/5559342e66bc4bf29cf4c79923853db2/dms3rep/multi/" + rel + '-side.png';
    // }
 ...
 $(document).ready(function(){
   ...
   function activeTab(){
       $("#basic-visualizer").addClass("active");
       $("#all-component-visualizer").removeClass("active");
   ...
   function activeTab2(){
    $("#basic-visualizer").removeClass("active");
    $("#all-component-visualizer").addClass("active");
